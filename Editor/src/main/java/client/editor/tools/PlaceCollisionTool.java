...
public class PlaceCollisionTool extends EditTool<Object> {

	public PlaceCollisionTool(Editor editor) {
		super(EditToolType.PLACE_COLLISION, editor);
	}
